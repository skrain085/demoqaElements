...
WebDriver driver;
	...
	public void FunctionMethod() {
		try {
			...
			Thread.sleep(2000);
			//Click on DownArrow to open the check box tree_Home
			driver.findElement(By.xpath("//button[@title='Toggle']")).click();
			Thread.sleep(2000);
			//Click on DownArrow to open the check box tree_Desktop
			driver.findElement(By.xpath("//div[@id=\"tree-node\"]/ol/li/ol/li[1]/span/button")).click();
			Thread.sleep(2000);
			//Click on CheckBox_Notes
			driver.findElement(By.xpath("//label[@for='tree-node-notes']/span")).click();
			Thread.sleep(2000);
			//Click on DownArrow to open the check box tree_Documents
			driver.findElement(By.xpath("//*[@id=\"tree-node\"]/ol/li/ol/li[2]/span/button")).click();
			Thread.sleep(2000);
			//Click on CheckBox_Office
			driver.findElement(By.xpath("//label[@for='tree-node-office']/span")).click();
			Thread.sleep(2000);
			//Click on DownArrow to open the check box tree_Downloads
			driver.findElement(By.xpath("//*[@id=\"tree-node\"]/ol/li/ol/li[3]/span/button")).click();
			//Click on CheckBox_WordFile.Doc
